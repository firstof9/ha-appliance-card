...
// 24x24 SVG Path Definitions with data-tooltip attributes for modern hover tooltips

// Water Tap / Faucet (IEC 60417 Water Supply / Tap Symbol)
const renderWaterTap = (title: string) => svg`
  <svg class="secondary-icon alarm active" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" data-tooltip="${title}">
